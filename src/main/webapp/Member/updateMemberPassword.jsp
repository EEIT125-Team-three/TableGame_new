...
<form class='center' method="POST" action="updateMember">
        ...
        <legend class="UMP_title">密碼更改</legend>       
			...
			<td><input class="UMP_input" type="password" name="password" id="password1" size="30" placeholder="請輸入密碼"/>
			...
			<td><input class="UMP_input" type="password" name="password" id="password2" size="30" onblur="checkPasswordAgain()" placeholder="請輸入密碼"/>
