					...
					<div class="updateform">
						...
						<table cellspacing="2" cellpadding="1" border="1">
							...
							<tr>
								...
								<td><form:input type="text" path="activity" id="Act" size="10"
										maxlength="10" placeholder="新增活動或課程" /><span
									id="actsp2" class="SH_span"></span></td>
							</tr>
							<tr>
								<td><label class="u1">活動形式:</label></td>
								<td><form:input type="text" path="actType" id="Type"
										size="10" maxlength="10" placeholder="活動類型" /><span
									id="actsp3" class="SH_span"></span></td>
							</tr>
							<tr>
