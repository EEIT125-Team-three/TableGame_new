...
英文名字:<input type='text'  name='E_name' required='required'><br>

中文名字:<input type='text'      name='C_name' required='required'><br>
...
價錢:<input type='text'      name='Price' required='required'><br>
瀏覽數:<input type='text'      name='viewCount' required='required'><br>
上市日期:<input type='date'      name='date' required='required'>
<!-- <span style="font-size:smaller;color:gray">格式ex:yyyy-MM-dd</span> -->
<br>
庫存:<input type='text'      name='storage' required='required'><br>
