...
// ---------------------------------------------------------基本資料
	...
	private String subject = "找回密碼確認信"; // 標題
	private String txt = "<h1>親愛的用戶您好，請點擊以下連結更換新密碼</h1><a href='http://localhost:8080/TestVersion/Member/newPassword.jsp'>http://localhost:8080/TestVersion/Member/newPassword.jsp</a>"; // 內容
