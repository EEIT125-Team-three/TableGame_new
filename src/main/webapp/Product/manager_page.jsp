            ...
            <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
                ...
                <body class="header_body">
                    ...
                    <div id="manager_div">
                        <fieldset style="display:none;border:none;text-align:center;font-size:x-large;line-height:1.5;font-weight:bold" id="search_fieldset">
                            ...
                            <form action='SearchGame' method='POST'>
                                遊戲編號 :<input type='text' name='productId' required='required'><br> 英文名稱 :<input type='text' name='E_name'><br> 中文名稱 :<input type='text' name='C_name'><br> 作者 :<input type='text' name='G_maker'><br> 插畫家 :<input type='text'
                                    name='Price'><br> 瀏覽數 :<input type='text' name='viewCount'><br> 上市日期 :<input type='text' name='date'><br> 庫存 :<input type='text' name='storage'><br>
                        ...
                        <fieldset style="display:none;border:none;text-align:center;font-size:x-large;line-height:1.5;font-weight:bold" id="creat_fieldset">
                            ...
                            <form:form action='InsertGame' method='POST' modelAttribute='gb'>
                                ...
                                英文名字:<input type='text' name='E_name' required='required'><br> 中文名字:

                                <input type='text' name='C_name' required='required'><br> 圖片連結:
                                <input type='text' name='img_url'><br> 創作者:
                                <input type='text' name='G_maker'><br> 插畫家:
                                <input type='text' name='iss'><br> 內容:
                                <input type='text' name='info'><br> 價錢:
                                <input type='text' name='Price' required='required'><br> 瀏覽數:
                                <input type='text' name='viewCount' required='required'><br> 上市日期:
                                <input type='date' name='date' required='required'>
                                <!-- <span style="font-size:smaller;color:gray">格式ex:yyyy-MM-dd</span> -->
                                <br> 庫存:
                                <input type='text' name='storage' required='required'><br>
                    ...
                    <div class="manager_divst">
                        <img src="${pageContext.request.contextPath}/images/勇氣徽章.png" style="height: 300px; width: 300px; margin-top: 15px;" onclick="manager_search_display()">

                        <img src="${pageContext.request.contextPath}/images/愛心徽章.png" style="height: 300px; width: 300px; margin-top: 15px;" onclick="manager_search_display()">

                        <img src="${pageContext.request.contextPath}/images/誠實徽章.png" style="height: 300px; width: 300px; margin-top: 15px;" onclick="manager_search_display()">
                        <p>搜尋、刪除、修改資料庫中的遊戲</p>
                    </div>

                    <div class="manager_divst">
                        <img src="${pageContext.request.contextPath}/images/純真徽章.png" style="height: 300px; width: 300px; margin-top: 15px;" onclick="manager_creat_display()">
                        <p>新增資料庫中的遊戲</p>
